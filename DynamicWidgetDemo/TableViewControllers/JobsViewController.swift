...
class JobsViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        TableViewManager.registerTableView(tableName: Tables.Jobs, tableView: self.tableView)
    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return  TableViewManager.getTableRowCount(tablename: Tables.Jobs)
    }
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let modelName = TableViewManager.getTableWidgetAt(tableName: Tables.Jobs, position: indexPath.row)
        if modelName == "NA" {
