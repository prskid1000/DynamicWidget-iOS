...
class MyAppliesViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        TableViewManager.registerTableView(tableName: Tables.MyApplies, tableView: self.tableView)
    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return  TableViewManager.getTableRowCount(tablename: Tables.MyApplies)
    }
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let modelName = TableViewManager.getTableWidgetAt(tableName: Tables.MyApplies, position: indexPath.row)
        if modelName == "NA" {
