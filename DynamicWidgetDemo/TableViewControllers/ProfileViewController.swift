...
class ProfileViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        TableViewManager.registerTableView(tableName: Tables.Profile, tableView: self.tableView)
    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return  TableViewManager.getTableRowCount(tablename: Tables.Profile)
    }
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let modelName = TableViewManager.getTableWidgetAt(tableName: Tables.Profile, position: indexPath.row)
        if modelName == "NA" {
